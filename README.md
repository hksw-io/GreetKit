...
```swift
.package(url: "https://github.com/hksw-io/GreetKit.git", from: "2.0.0")
```

Or in Xcode: **File > Add Package Dependencies**, enter the URL above, and choose **Up to Next Major Version** from `2.0.0`.
